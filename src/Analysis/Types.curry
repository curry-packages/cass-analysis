...
combined2SimpleFuncAnalysis :: (Read a, Read b) => String -> Analysis a -> Analysis b
                  -> (ProgInfo a -> ProgInfo b -> FuncDecl -> c) -> Analysis c
...
runWithBaseAnalysis :: Read a => Analysis a -> (ProgInfo a -> (input -> b))
                    -> String -> IO (input -> b)
...
--- Loads the results of the base analysis and put it as the first
--- argument of the main analysis operation which is returned.
runWith2BaseAnalyses :: (Read a, Read b) => Analysis a -> Analysis b
